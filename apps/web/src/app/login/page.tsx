      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            <blockquote className="text-xl text-muted-foreground italic font-display">
              &ldquo;Finally, a Git host that understands how I actually work.
              Sync-by-default means I never worry about losing progress.&rdquo;
            </blockquote>
